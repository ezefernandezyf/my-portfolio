...
A new i18n namespace `geoseoopencodecasestudy` SHALL be created with ES/EN locale files (all required keys: header._, meta._, summary, problem, solution, architecture, deepDive).
