...
describe('ProjectsPage', () => {
  it('renders the editorial directory shell and project actions', () => {
    ...
    expect(screen.getAllByRole('link', { name: /view repo|ver repo/i })).toHaveLength(5);
    expect(screen.getAllByRole('link', { name: /view demo|ver demo/i })).toHaveLength(5);
    expect(screen.getAllByRole('link', { name: /view case study|ver case study/i })).toHaveLength(5);
  });
});
