...
describe('ProjectsPage', () => {
  it('renders the editorial directory shell and project actions', () => {
    ...
    expect(
      screen.getByRole('heading', { name: /projects|proyectos/i, level: 1 }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole('textbox', { name: /search projects|buscar proyectos/i }),
    ).toBeInTheDocument();
    ...
    expect(screen.getAllByRole('link', { name: /view case study|ver case study/i })).toHaveLength(
      6,
    );
  });
});
