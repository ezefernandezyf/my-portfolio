  ...
  return (
    <Suspense fallback={<div className="flex min-h-screen items-center justify-center"><div className="h-8 w-8 animate-spin rounded-full border-2 border-primary border-t-transparent" /></div>}>
      ...
      <Route path="/" element={<MainLayout />}>
        ...
        <Route path="/projects/geo-saas" element={<ProjectCaseStudyPage projectId="geo-saas" namespace="geosaascasestudy" />} />
      ...
      <Route path="/en" element={<MainLayout />}>
        ...
        <Route path="/en/projects/geo-saas" element={<ProjectCaseStudyPage projectId="geo-saas" namespace="geosaascasestudy" />} />
        <Route path="privacy" element={<PrivacyPage />} />
        <Route path="contact" element={<ContactPage />} />
        <Route path="not-found" element={<NotFoundPage />} />
